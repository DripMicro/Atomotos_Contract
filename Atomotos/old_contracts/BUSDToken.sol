...
contract BUSDToken is Context, IBUSDToken {
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[_sender][_msgSender()].sub(
                _amount,
                "BUSD: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][_spender].sub(
                _subtractedValue,
                "BUSD: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _transfer(
        ...
        require(_sender != address(0), "BUSD: transfer from the zero address");
        require(_recipient != address(0), "BUSD: transfer to the zero address");

        _balances[_sender] = _balances[_sender].sub(
            _amount,
            "BUSD: transfer _amount exceeds balance"
        );
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "BUSD: mint to the zero address");
    ...
    function _burn(address _account, uint256 _amount) internal {
        require(_account != address(0), "BUSD: burn from the zero address");

        _balances[_account] = _balances[_account].sub(
            _amount,
            "BUSD: burn amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(_owner != address(0), "BUSD: approve from the zero address");
        require(_spender != address(0), "BUSD: approve to the zero address");
